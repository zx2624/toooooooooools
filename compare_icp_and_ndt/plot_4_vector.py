...
with open(sys.argv[4]) as f:
	for l in f:
		line = l.split()
		x_4.append(float(line[1]))
		y_4.append(float(line[2]))
		yaw_4.append(float(line[6]))
...
plt.quiver(x_3, y_3, cos_3, sin_3, scale=4, scale_units='inches', color='b', label="NDT")
plt.quiver(x_4, y_4, cos_4, sin_4, scale=4, scale_units='inches', color='k', label="GT")
