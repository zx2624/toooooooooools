...
def main():
    ...
    parser = argparse.ArgumentParser(description='Filter bag files based on start stamp and finish stamp with the possibilities of filtering topics.')
    ...
    print("Start stamp: " + str(args.start_stamp))
    print("End stamp: " + str(args.end_stamp))
