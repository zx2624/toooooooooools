...
xs_3 = map(float, [l[4] for l in ls])
ys_3 = map(float, [l[8] for l in ls])
...
plt.scatter(xs_1, ys_1, color = 'red', label="z > -1.6")
plt.scatter(xs_2, ys_2, color = 'green', label="z > 0")
plt.scatter(xs_3, ys_3, color = 'blue', label="z > 1.6")
